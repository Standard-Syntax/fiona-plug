...
**Key Information**:
- Finding or quote (with link to specific section if possible)
...
- Each prompt to this agent must be **self-contained** — include all context needed
- Do NOT write to TodoWrite — return all findings in your response text
- Always include direct URLs so the orchestrator can reference or fetch further
